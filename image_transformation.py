...
def process_and_stack_images(crc_dask_arrays, sample_names, marker_dict, shift_in_log_pixels_dict, reference_sample, num_bins, output_directory, plot_img=True, plot_dist=True, plot_single_cell_corr=True, save_image=True):
        ...
        for marker_index, marker in enumerate(marker_dict):
            ...
            if plot_single_cell_corr: 
                ...
                if gmm_analysis: 
                    ...
                    normalized_threshold = plot_gmm(normalized_X_mesmer['intensity_mean'].reshape(-1, 1), f"CRC0{sample_index+1} {marker} Normalized", f"{marker} Normalized", xlims=(4,9))
